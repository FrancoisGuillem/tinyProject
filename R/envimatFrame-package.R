...
#'         Both possibilities will setup a project root directory and a bisic file tree.  
...
#'         Additionally, three scripts are created and opened in the script editor: \code{data.R} for the import and processing of data, 
#'         \code{main} for the analysis of the data and \code{start} for all instructions and environment setup that have to be exetuted 
#'          everytime the project is opened (load libraries, define constants and functions, etc.).
#'          When the user opens the project in Rstudio, the script \code{start} is automatically executed, hence it can used  to automatically load important specific functions or constants.
